...
CarpGenerator.prototype = Object.create(ConfigGenerator.prototype);

CarpGenerator.prototype.validate = function(config) {
  return (config && config.carp);
}

CarpGenerator.prototype.writeRoot = function(config, root, configWriter) {
